...
const file_rpc_update_user_proto_rawDesc = "" +
	...
	"\rprofile_photo\x18\x05 \x01(\tH\x03R\fprofilePhoto\x88\x01\x01\x12\x19\n" +
	"\x05email\x18\x06 \x01(\tH\x04R\x05email\x88\x01\x01\x12\x1f\n" +
	"\bpassword\x18\a \x01(\tH\x05R\bpassword\x88\x01\x01B\r\n" +
	"\v_first_nameB\f\n" +
	"\n" +
	"_last_nameB\x0f\n" +
	"\r_phone_numberB\x10\n" +
	"\x0e_profile_photoB\b\n" +
	"\x06_emailB\v\n" +
	"\t_password\"2\n" +
	"\x12UpdateUserResponse\x12\x1c\n" +
	"\x04user\x18\x01 \x01(\v2\b.pb.UserR\x04userB*Z(github.com/Shegs-Emma/sisikemi_server/pbb\x06proto3"
